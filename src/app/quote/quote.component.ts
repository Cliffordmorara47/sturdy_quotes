...
export class QuoteComponent implements OnInit {
  Quotes: Quote[] = [
    new Quote(0, "Tough Moments", "Don't worry about the things or people that you have lost in your life, things and people who are meant to be with you are with you", "Clifford Morara", 0, 0, new Date(2010,3,23)),
